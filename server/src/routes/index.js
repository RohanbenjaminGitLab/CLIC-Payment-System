...
router.delete('/courses/:id', authenticate, anyRole, courses.remove);
...
router.delete('/batches/:id', authenticate, anyRole, batches.remove);
...
router.post('/students/:id/reactivate', authenticate, anyRole, students.reactivate);
