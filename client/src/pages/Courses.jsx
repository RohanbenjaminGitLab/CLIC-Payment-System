...
export function Courses() {
  ...
  const canManageCourses = isAdmin || isManager || isStaff;
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-2 w-full md:w-auto">
          ...
          <div className="flex rounded-lg border p-0.5 w-full sm:w-auto">
            <button
              className={`flex-1 sm:flex-none px-3 py-1 text-sm rounded-md ${view === 'table' ? 'bg-[#751c58] text-white' : ''
                }`}
            ...
            <button
              className={`flex-1 sm:flex-none px-3 py-1 text-sm rounded-md ${view === 'cards' ? 'bg-[#751c58] text-white' : ''
                }`}
